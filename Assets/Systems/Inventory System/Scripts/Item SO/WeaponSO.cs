...
namespace Dreamers.InventorySystem
{
    public class WeaponSO : ItemBaseSO, IEquipable,IWeapon
    {
        ...
        public void Equip(BaseCharacterComponent player, Animator anim=null)
        {
        ...
        /// <returns></returns>
        public bool EquipItem(CharacterInventory characterInventory, BaseCharacterComponent player, Animator Anim)
        {
